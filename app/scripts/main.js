...
(function() {
  ...
  var QRCodeManager = function(element) {
    ...
    // spawn a web worker for qr code decoding
    var qr_worker = new Worker('/scripts/jsqrcode/qrworker.js');
    ...
    this.detectQRCode = function(imageData, callback) {
      ...
      qr_worker.addEventListener('message', function(e){
        var result = e.data;
        if (result !== undefined) {
      ...
      // post image data to worker here for decoding
      qr_worker.postMessage(imageData);
